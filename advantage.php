<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tr>
    <td align="center" valign="top"><img src="<?=$img5src;?>" border="0" style="display: block;height:108px;max-height:100%;max-width:100%;"/><div style="height: 10px; line-height: 10px; font-size: 7px;"></div></td>
    <td style="width: 5px; max-width: 5px; min-width: 5px;" width="5"></td>
    <td align="center" valign="top"><img src="<?=$img6src;?>" border="0" style="display: block;height:108px;max-height:100%;max-width:100%;"/><div style="height: 10px; line-height: 10px; font-size: 7px;"></div></td>
    <td style="width: 5px; max-width: 5px; min-width: 5px;" width="5"></td>
    <td align="center" valign="top"><img src="<?=$img7src;?>" border="0" style="display: block;height:108px;max-height:100%;max-width:100%;"/><div style="height: 10px; line-height: 10px; font-size: 7px;"></div></td>
    <td style="width: 5px; max-width: 5px; min-width: 5px;" width="5"></td>
    <td align="center" valign="top"><img src="<?=$img8src;?>" border="0" style="display: block;height:108px;max-height:100%;max-width:100%;"/><div style="height: 10px; line-height: 10px; font-size: 7px;"></div></td>
  </tr>
  <tr>
